    ...
    public class PredictedRigidbody : NetworkBehaviour
    {
        ...
        protected virtual void SmoothFollowPhysicsCopy()
        {
            ...
            */
            ...
            Vector3 currentPosition = tf.transform.position;
            Quaternion currentRotation = tf.transform.rotation;
            ...
            Vector3 physicsPosition = physicsCopyTransform.transform.position;
            Quaternion physicsRotation = physicsCopyTransform.transform.rotation;
        ...
        void FixedUpdate()
        {
            ...
            if (isClientOnly)
            {
                ...
                if (onlyRecordChanges)
                {
                    ...
                    Vector3 position = tf.transform.position;
                    Quaternion rotation = tf.transform.rotation;
